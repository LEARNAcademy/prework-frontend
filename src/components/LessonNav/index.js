                                            ...
                                            <ul className="module-list">
                                                ...
                                                {lessons.map((l,i,arr)=> {
                                                    ...
                                                    if(l.code_module_id === mod.id){
                                                        {/* if this is the first lesson, or if it's completed, override flag and enable the lesson*/}
                                                        ...
                                                        return (
                                                            <li key={i} className={`nav-list ${flag}`}  style={{opacity: l.completed? '.2':'',color:l.completed? 'green':''}} onClick={ ()=>this.captureContent(l)}>{l.title}</li>
                                                        ) 
                                                    }
                                                })}
